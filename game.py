...
class Game:
    ...
    def run(self):
        ...
        while True:
                ...
                if self.tilemap.solid_check(projectile[0]):
                    ...
                    if self.player.rect().collidepoint(projectile[0]):
                        ...
                        for i in range(30):
                            ...
                            self.particles.append(Particle(self, 'particle', self.player.rect().center, velocity=[math.cos(angle + math.pi) * 0.5, math.sin(angle + math.pi) * speed * 0.5], frame=random.randint(0, 7)))
            ...
            display_stillhouette = display_mask.to_surface(setcolor=(0, 0, 0, 180), unsetcolor=(0, 0, 0, 0))
            for offset in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
                self.display_2.blit(display_stillhouette, offset)
